...
public class InteractionSearchService {
    ...
    public SearchGraphJson getGraphJson
        ...
        Page<SearchInteraction> interactions = findInteractionForGraphJson(query, detectionMethodFilter,
        ...
        for (SearchInteraction searchInteraction : interactions) {
            try {
                ...
                if (!interactorSet.contains(searchInteraction.getInteractorAAc())) {
                    ...
                    searchGraphNode.setInteractorId(searchInteraction.getIdA());
                ...
                if (!interactorSet.contains(searchInteraction.getInteractorBAc())) {
                    ...
                    searchGraphNode.setInteractorId(searchInteraction.getIdB());
