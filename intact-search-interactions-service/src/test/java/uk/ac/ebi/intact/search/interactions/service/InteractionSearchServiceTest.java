...
public class InteractionSearchServiceTest {
    ...
    public void facetTest() {
        ...
        Page<FacetFieldEntry> facetFieldEntryPage = interaction.getFacetResultPage(SearchInteractionFields.INTERACTION_NEGATIVE);
        ...
        facetFieldEntryPage = interaction.getFacetResultPage(SearchInteractionFields.INTERACTION_DETECTION_METHOD_STR);
        Assert.assertFalse(facetFieldEntryPage.getContent().isEmpty());
        for (FacetFieldEntry facetFieldEntry : facetFieldEntryPage.getContent()) {
            final String value = facetFieldEntry.getValue();
        ...
        facetFieldEntryPage = interaction.getFacetResultPage(SearchInteractionFields.INTERACTION_TYPE_STR);
        Assert.assertFalse(facetFieldEntryPage.getContent().isEmpty());
        for (FacetFieldEntry facetFieldEntry : facetFieldEntryPage.getContent()) {
            final String value = facetFieldEntry.getValue();
